...
class Message:
	def __init__(self):
		self.verbs = ["Generating", "Uploading", "Downloading", "Parsing",
					...
					"Inserting", "Hand-crafting"]
		self.nouns = ["data", "the cloud", "DNA", "nucleotides", "RAM",
					...
					"FASTQs", "cores", "syntax", "bits and bytes"]
